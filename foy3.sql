...
IF EXISTS (SELECT name FROM sys.databases WHERE name = 'SirketVeritabani')
BEGIN
    ALTER DATABASE SirketVeritabani SET SINGLE_USER WITH ROLLBACK IMMEDIATE
    DROP DATABASE SirketVeritabani
END
GO
